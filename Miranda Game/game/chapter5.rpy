...
label chapter5:
    ...
    m "I finish translating the title of the book, and sure enough, there it is in front of me: Aut inveniam viam aut faciam. If I cannot find a way, I will make one. It’s a common maxim that we translated in one of my classes, ringing a faraway bell in my mind."
    ...
    m "The windows showing the story of the kingdom… the mysterious bird man with the sash… a book in code… everything seems just out of the way enough that it might be something to chase, but there is always the risk that it will push me off schedule just enough to ruin my way home forever."
    ...
    m "Originally, I’d assumed it was some kind of handwritten historical text, but in reality, it appears to be more of a diary. The author is only listed as The Magician, no actual name provided anywhere at all, and the portion of the text loosely describes the need to ‘travel away’ to escape something that isn’t specified."
    
    m "There are a few interspersed jottings on various alchemical experiments, and I recognize brief scribblings and symbols that represent elements, planets, metals, and plants. The first entry is dated as August of 1472, but the date system quickly shifts into something much simpler."
    ...
    k "\"He… is. I think. He… looks older, so he must be…\" she trails off. \"Regardless, I can remember when he first arrived. They said he came from a trip, arrived from far off, but… I’m sorry, it’s getting really fuzzy in my head.\" She squeezes her eyes shut, rubbing at her temples with her fingertips."
    ...
    m "I feel like the wheels in my head are turning, but I’m spinning in place. Noah ad Kylie are all NPCs. They’re game characters. The system doesn’t work for them like it does for me, they can’t see Fairy… so how could they possibly be affected by memory loss in the same way I am?"
    
    m "\"Question— what do you remember?\""
    
    k "\"Not much,\" she says with a snort."
    
    k "\"I’m Noah’s half-sister. My mom died a long time ago, not too long after giving birth to me. I know a few things about magic, but I keep feeling like I’m spinning in circles. I get déjà vu every time I try to read more about alchemy, the library somehow feels too small and endless all at the same time…\" She sighs, shoulders slumping."
    ...
    # TODO
    #Go back to reading (-1 affection)
    ...
    label chapter5_encounter:
        ...
        m "I am positive I know exactly who she is talking about. The same thing happened to Noah in the castle entryway. For whatever reason, I am the only one who seems to remember the man in the bird mask without issue, and I am also the only one he appears to regularly seek out."
        ...
        label chapter5_skip1:
            ...
            # TODO
            #Exit Lorenzo and kylie sprites
            ...
            # TODO
            #Sprite: exit fairy, add Lorenzo and kylie
            ...
            label chapter5_encounter2:
                ...
                m "I don’t think, I just listen to instructions. Still on the floor, I grab for one of the Patcher’s ankles and swipe him off balance by pulling out one of his legs from under him. Though his mask stays firmly tied to his face, his wide-brimmed hat flies off his head and his body thuds to the floor like a sack."
                ...
                m "Because he put me here, I remind myself. Lorenzo wasn’t ever helping me, in the end. The Fairy was helping me, stationed as the system interface. But if Lorenzo was trying to get me to organize the library and the game put me here was a librarian, then the question remains…"
                ...
                label chapter5_encounter3_end:
                    ...
                    # TODO
                    #CHOICE: "I can’t stay." Or "Maybe it wouldn’t be so bad."
                    ...
                    # TODO
                    #IT WOULDN’T BE SO BAD – BAD END 2
                    label bad_end_2:
