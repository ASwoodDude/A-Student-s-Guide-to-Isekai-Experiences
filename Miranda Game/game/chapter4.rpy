...
label chapter4:
    ...
    m "I woke up as soon as the sun rose and got started organizing, moving files and shuffling boxes and reorganizing bookshelves for a couple of hours before I made my way to the kitchen for breakfast. I swept out the floor, wiped down the furniture, and created a dump pile for anything that definitely needs to be thrown out."
    ...
    m "Contrary to my expectations, Noah is actually good company. He’s quiet, doesn’t feel the need to speak too much expect to ask organizational questions, and I get a good chunk of work done over the course of the time he spends looking for the tome."
    ...
    m "I bite my lip, trying to think about how best to describe it. \"It’s like… I’m always working. At every hour of the day or night, I have to be ready to work. I’m answering e-mai— uh, correspondences— at 11PM, and if I stop to read a book for enjoyment or eat a good meal, that’s too much time and there are other things I could have done in that moment that would benefit my career more. Does that make any sense?\""
    ...
    #DIALOGUE OPTION [I am sure you can be a wonderful healer and a king (plus 2 affection); It’s good to have hobbies (no change); I think you should focus on ruling (minus 2 affection)]
    ...
    menu:
        ...
        "I think you should focus on ruling":
            # -2 affection
            jump ruling
    # I am sure you can be a wonderful healer and a king (plus 2 affection);
    # It’s good to have hobbies (no change);
    # I think you should focus on ruling (minus 2 affection)
    ...
    label hobbies:
        ...
        m "He sounds so sad, and it breaks my heart, but I don’t know what to tell him. I know very well how a career path can sweep in from the side and take over your life, and sometimes… Well, sometimes we love it. Other times, it becomes our life in a way we really don’t enjoy at all."
    ...
    label choice4_1_end:
        ...
        menu: 
            ...
            # I’d love to look around (+1 affection)
            # Um… sure? (no change)
            # I really have work I need to do (-1 affection)]
        ...
        label explore:
            ...
            m "It doesn’t take too long to get to the pasture, and I find that I recognize a few things here and there from when I went to return the pocketwatch to Tarran. That’s a small miracle in itself as far as I’m concerned, as I’m absolutely terrible with directions and the fact that every single hallway in the castle looks identical does not help my confusion."
            ...
            #play music pasture_theme
            
            # TODO
            #Sound: intermittent sheep bleating
            ...
            m "It’s a soft tune, the melody carried by a recorder in a minor key, like many European folk songs. Something pulls at a memory in the back of my mind, information about shepherds and pan pipes and an eighteenth-century French fascination with \"simple\" living and pastoral scenes."
            
            m "Someone had to pick this music. Right now, considering that I’m the only one who hears it, I can’t say if it’s associations from my own mind, something from the game, whoever created this game, or something else entirely, but someone had to pick it, and they picked it intentionally."
            ...
            m "In the real world, there is no programming, but there are certainly layers of sound all around us. Sound is vibration, vibration is movement, and movement is everywhere. Even though I may not take particular notice of the sound of my own footsteps, they follow me wherever I go, overlaying with construction, singing birds, and snippets of conversation as I pass people, and those layers differ when I am in different places."
            ...
            m "\"Makes sense,\" I mutter, nodding, but I’m distracted by the grand scale of the room. The last time I was here, I was too overwhelmed and terrified to take in how beautiful the room really is. Brightly-colored banners hang between five stained glass windows, each with a different scene."
            ...
            m "I start to think about the military implications of a march theme before I remember that I know very little about this kingdom’s history, fictional or otherwise. Then again, perhaps it doesn’t matter. Perhaps since this music is made for me, the player, to hear… then it’s just based on my perception."
            ...
            m "When I glance over, he’s reaching towards where a battered book is lying at the corner of the windowsill. I didn’t notice it before, too preoccupied with the window itself, but it appears to have been sitting there for a while. Noah brushes dust off the cover and coughs, flipping through the pages."
            ...
            m "I can see a jumble of characters in the Roman alphabet, separated by spaces, but I can’t make out the seemingly random jumble of letters. They look more like keyboard smashes than an actual language, despite the spacing, and even the author name and book title on the first page look like random text."
            ...
            # TODO
            #Sprite: fade OUT Lorenzo
            hide lorenzo sprite
            
            # TODO
            #Music: castle day theme
            ...
            m "My instinct says it’s something about arthritis, tumors, brain damage, or anything else not inherently visible that could cause medical issues, but I’m interested to know what kind of science is in this place, even if it’s pretty far off from modern medicine. Noah’s entire demeanor shifts as he begins to speak, cheering him immediately."
            ...
            m "\"It’s…\" I pause, licking my dry lips as I try to think of how to phrase it. \"When you place so much value on one part of yourself and build your entire personality around it, then what happens when that collapses or changes? Because it will change, at the least, in one way or another.\""
            
            m "\"I wonder if that’s why people are so resistant to changing the way they do things sometimes, especially in their careers. It’s changing part of this central identity they’ve build for themselves, in a way, and it’s natural to be resistant to that, because in your mind it’s subconsciously connected to changing a very personal and important part of yourself.\""
            
            m "\"You have to be more than a career and more than a hobby and more than a someone who does something. Or maybe you have to be someone who does a lot of somethings. I don’t really know, but I know that you can’t define your whole self by just a part of who you are.\""
            ...
            m "I remember my childhood. I remember school, I think, and I remember vague impressions of classrooms and blurry silhouettes of people, but I don’t remember what I was studying. I remember being in the library before I entered this world, but I don’t remember what I was doing or why I was there."
            ...
            label chapter4_redirect:
                ...
                m "\"At this rate, I’m really not going to be able to get anything else done today.\" A quick glance out the window reveals that the sun is already low in the sky. There’s precious little time until we lose the light, and besides searching with Noah and placing a few boxes, I’ve gotten nothing done today. We spent more time looking for that book than I’d intended."
                ...
                f "\"Could be I’m reading into this, but if he’s a patch, that means he wasn’t here to begin with, right? It implies he was added later for something. I know I’m the system interface. I don’t have information, but I can help you as the player interact with the game functions. We don’t really know what Bird Man was added for, though, and I don’t remember when he got here.\""
                ...
                label he_isnt:
                    ...
                    m "Looking back, he’s given me precious little information at the cost of spiking my anxiety over the whole situation to skyscraper heights. He’s told me that organizing the library is the way home, but… none of the other characters seems to be encouraging me to do that in the same way he is."
