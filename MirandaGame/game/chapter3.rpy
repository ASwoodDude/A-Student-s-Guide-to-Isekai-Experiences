...
label chapter3:
    ...
    label ask:
        ...
        label leslie_skip:
            ...
            m "The ghost of one or two embers glow in the bank of ashes in the hearth, heat still radiating even though the fire has long been put out. Magic-powered lamps cast a soft glow around the rest of the room, just enough to see by."
            ...
            scene bg basic bedroom with fade
