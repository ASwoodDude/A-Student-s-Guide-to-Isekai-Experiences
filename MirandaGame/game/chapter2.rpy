...
label chapter2:
    ...
    m "As we come closer, I realize that there seems to be a huge, fenced-in pasture around the entire castle that encloses a herd of happily grazing sheep." 

    m "They are the fluffiest, whitest, and largest sheep I’ve ever seen in my life, two to three times bigger than the typical domestic ones on earth farms."
    ...
    m "I suspect earth cash would be useless here, if I was even wearing my own clothes and could attempt to fish a couple coins from my lint-ridden pockets."
    ...
    m "At least, I presume they’re staff. They’re dressed in practical clothing and seem to be rushing about as though they know where they’re going, carrying boxes or baskets or lists this way and that."

    m "Essentially, they’re doing the opposite of me, and I’m positive I stick out like a sore thumb as I simply try not to run into anyone before I can slip inside the door."
    ...
    m "The stone walls are simple and practical, with high and narrow windows that make the place look like it was built as a fortress rather than a place of luxury and comfort."
    
    m "A few comforts stand out despite the construction style, though. A plush carpet covers the stone floors, muffling the sound of footsteps that otherwise might echo in the corridor."

    m "Along the walls, both providing insulation and an additional source of muffling sound, are thick, white tapestries. Each one bears the image of a crest stitched on with brown thread that seems to shimmer gold in the hallway’s low lighting."
    ...
    m "I pause, suddenly wondering how these people are speaking modern English at all."
    ...
    f "\"Some things go by fantasy world rules, because I guess we ARE in a different world… but it’s still a game. If you can have dialogue boxes, you can have translation settings."
    ...
    m "I catch onto snippets of Leslie’s explanation as we walking, trying to drink in as much of the castle as possible. Though we seem to be traveling through a complex system of corridors, I do my best to make note of our path."

    m "It would be a good idea to know the lay of the land so I can move around easily, especially considering I am still not quite certain what the goal of this story actually is." 
    ...
    m "His blonde hair drapes slightly over his right eye, shining almost white in the sunbeam coming through one of the high windows. He smiles, well, sheepishly as he looks down at me."
    
    t "\"Sorry about that. Leslie says I need to be more aware of my surroundings.\" He extends  his hand for a welcoming shake."
    ...
    le "\"Oh, yes. It’s in a terrible state."

    le "The main library is decently organized, but I’m afraid the archive room is a true disaster,\" she says with a long sigh. \"It’s been used as a storage space for objects that simply have no other home for far too long, and now we… Wel, we simply can’t find a thing.\""
    ...
    m "Just as I am mentally calculating how to explain that I certainly do NOT know everything that Leslie thinks that I do without making myself sound delusional or useless, Leslie comes to a dead stop in front of a pair of large double doors."

    m "I only barely avoid running into her, stumbling back a step or two as she turns towards me."
    ...
    m "She trails off, making her way to the far side of the room, where a wooden door in the wall is almost entirely obscured by shadows."

    m "A part of me thrums with anticipation, wondering if all the fantasy stories I read as a child are true, if there’s a secret passage or a hidden stairway."
    
    m "Leslie throws opens the door and shrieks, diving out of the way. I am not fast enough."
    
  
    m "A pile of boxes made of something that feels suspiciously like Fantasy Cardboard comes crashing down on me and I stumble, landing on my rear on the hard wooden floor."

    m "The boxes simply keep falling, covering me in an avalanche of papers and clanking, random objects. They aren’t terribly heavy, but there are many of them, and the shock is enough to keep me pinned to the floor until the sound of falling objects finally ceases."
    ...
    m "It’s been hours just trying to put the boxes of papers into stacks of vaguely related files."

    m "I haven’t even started on the boxes of random objects yet, but I think it would be best to simply get into the room now and see what else is there beyond just a mountain of unorganized papers."
    ...
    m "\"Well, can you get some information on how to light those lamps? It’s getting dark.\" I gesture to the oil lamps lining the walls."

    m "There were also one or two on the tables around the room. Unfortunately, there weren’t any wicks in them when I checked earlier."
    ...
    m "I walk over to the archive door, which is actually a room about the size of a large broom closet… or my graduate office that I share with three other people."

    m "Running my hand across the wall in the darkness, I find another sconce with a button switch and turn on the lamp."
    
    m "I wish I could say the room looks better in the light, but it does not. It’s simply a clearer version of a big mess."

    m "One medium-sized table sits against the far wall, but at least I can’t say it’s dusty— there are papers, boxes, and strange objects littering the surface for any of the dust to reach the tabletop."
    ...
    m "As sift through the various objects around the archive, some of them feel perfectly normal, but I can’t help but notice that some of them sound… strange."

    m "And not just strange, but like they’re playing music from nowhere in particular. It changes with a few items. Some of them, I notice, don’t have any particular shift in sound. I go through a whole pile of miscellaneous library books, and I can hear the same sot of odd little ambient tune if I concentrate."

    m "Some of them, though, change sounds entirely. A box with a medal in it plays a proud fanfare in my ears when I open it, and I quickly snap it shut. A silver pocket watch plays a light and tinkling tune. A diary plays a melancholy melody on strings."
    ...
    label watch:
        ...
        t "\"When I had nightmares as a child, my father would sing me back to sleep."

        t "It was dark in our home, but I remember seeing the moonlight glinting off his watch. He said the watch didn’t run, but the ticking went perfectly with the tempo of the lullaby.\""
        ...
        m "Tarran’s eyes narrow for a moment, betraying his curiosity over the odd request, but he nods and begins to hum the tune."

        m "It’s short and simple, the perfect little piece for a children’s song, but what chills me to the core is that I know I have heard this music before."
        ...
        m "At that moment I realize how truly precious the memory is to him and how much that old, broken watch represents a part of his core memories and ideals."

        m "It is so essential to his personality that it has become the music that identifies him as a character."
        
        m "It is… humanizing, really. Logically, I know he’s not real."

        m "I know that he’s an NPC and this is a video game I’m trying to escape, but something is haunting about the symbolism of that music. Even if he isn’t a real human person with a real life and real dreams, he seems like it, just for a second."
        ...
        m "Looking past the fantasy version of arguably the most annoying plant in existence, I finally see what he’s pointing out."

        m "Part of the fence has collapsed, but it’s nearly impossible to see because of the vines. The sheep haven’t gone through the gap yet, but it’s likely only a matter of time before it causes trouble."
    ...
    label choice2_good:
        ...
        m "Not entirely, of course. I do like some parts of it, but being here with Tarran is making me wonder what I was missing outside in the sunlight all that time."

        m "I remember going camping with my parents as a kid, hanging out in a hammock under trees, and even going on long hikes through creeks and near waterfalls as a teenager."
        
        m "Why don’t I do that anymore, I wonder?"
        
        play music pasture
        
        m "It really doesn’t take long to fix the fence. Maybe 20 minutes at most, though I can tell it’s easier with a second pair of hands."

        m "Some rope, a new board, and a few long nails have everything back in place, and the sheep just bleat on like nothing is happening during the entire process."
    ...
    label encounter_skip:
        ...
        m "His green eyes are soft and kind, but the simple circlet and heavily embroidered doublet he wears puts me on edge."
